...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container" id="container">
        ...
        <li class="active"><a data-toggle="tab" href="#chuaduyet">Danh sách PR chưa duyệt <span class="badge" id="soluongpr_chuaduyet"></span></a></li>
    ...
    <script type="text/javascript">
         ...
         .fail(function (jqXHR, textStatus, errorThrown) {
            ...
            for (var i = 0; i < id_pb.length; i++)
            {
                $.ajax({
                    type: "POST",
                    async: false,
                    url: "/Webservice/dsnguoidung.asmx/BaoCaoSoLuongPRTheoThangTheoDonVi",
                    data: {
        ...
        function ShowChuaDuyet()
        {
            ...
            LayDataPRChuaDuyet(chuaduyet);
        }
        function LayDataPRChuaDuyet(chuaduyet) {

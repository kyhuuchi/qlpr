...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" id="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h3>
                    <p class="text-center font-weight-bold">PHIẾU ĐỀ XUẤT MUA HÀNG</p>
                </h3>
            </div>
        </div>
        <div class="row">
                            ...
                            <table class="table table-bordered" id="table_vattu">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="hidden" id="tongsoluong_notmask" /></td>
                                        <td></td>

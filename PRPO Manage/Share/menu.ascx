...
<div class="menu_top" id="cssmenu" style="margin:10px 0;">
    <ul id="menu_content"> 
        ...
        <li class=""><a href="/Pages/PR/TaoPO.aspx"><span class="glyphicon glyphicon-list-alt" style="padding-right: 5px;"></span>PO</a></li>        
        <li class=""><a href="/Pages/PR/TaoPO.aspx"><span class="glyphicon glyphicon-list-alt" style="padding-right: 5px;"></span>Kho</a></li>        
